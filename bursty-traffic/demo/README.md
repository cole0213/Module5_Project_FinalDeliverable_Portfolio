...
├── README.md                              # this file
├── frontend/
│   ├── README.md                          # dashboard + backend contract
│   └── index.html                         # Chart.js dashboard (canonical copy)
└── backend/
...
> The backend serves the frontend, so `static/index.html` is an identical copy of
> `frontend/index.html`. The `frontend/` folder keeps the client code visible and
