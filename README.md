...
│   └── images/              # Exported figures / graphs referenced above
├── demo/                    # Load-simulation source (3-server + burst trigger)
│   ├── backend/             # Server, capacity model, auto-scaler, queue
│   └── frontend/            # Real-time RPS dashboard + "티켓 오픈!" trigger
└── LICENSE
```
